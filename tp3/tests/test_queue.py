...
from tp3.queue_ import Queue, q_new, q_size, q_is_empty, q_enqueue, q_dequeue, q_is_full, q_str, q_rear, q_front

ROLLING_QUEUE = 7  #


### Test all Queue functions at once
### May be run separately with <file_name>::TestQueue::<function_name>
class TestQueue:
