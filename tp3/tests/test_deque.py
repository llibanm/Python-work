...
from tp3.deque import Deque, d_new, d_is_empty, d_len, d_str, d_front, d_rear, \
    d_push_front, d_push_rear, d_pop_front, d_pop_rear


# Test the all Deque data structure and operations
class TestDeque:
